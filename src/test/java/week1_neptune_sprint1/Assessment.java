...
public class Assessment {
	...
	public static void main(String[] args) throws Throwable {
		...
		// String closed1 =
		// "//span[text()='Closed']/following-sibling::lightning-formatted-text";
		// String open1 =
		// "//span[text()='Open']/following-sibling::lightning-formatted-text";
		...
		// identifying the CLOSED + OPEN values
		/*
		 * JavascriptExecutor js1 = (JavascriptExecutor)dr; String close_val =
		 * (String)js1.executeScript("return document.getElementById(closed1);",dr.
		 * findElement(By.xpath(closed1))); String open_val
		 * =(String)js1.executeScript("return document.getElementById(open1);",dr.
		 * findElement(By.xpath(open1))); System.out.println(close_val+"----"+open_val);
		 */
		...
		// scroll_page(p1.getProperty("dboard_name_1"),p1.getProperty("dboard_name_2"),
		// i, dr, js1,nm1);
		Assessment as1 = new Assessment();
		scroll_page(as1, dr, p1, js);
		...
		i=1;
		try {
		while (dr.findElement(By.xpath(p1.getProperty("dboard_name_1") + i + p1.getProperty("dboard_name_2"))).isDisplayed()) {
			name = dr.findElement(By.xpath(p1.getProperty("dboard_name_1") + i + p1.getProperty("dboard_name_2"))).getText();
			js.executeScript("arguments[0].scrollIntoView()",dr.findElement(By.xpath(p1.getProperty("dboard_name_1") + i + p1.getProperty("dboard_name_2"))));
			if (name.equals(nm1)) 
	...
	public static void scroll_page(Assessment as1, WebDriver dr, Properties p1, JavascriptExecutor js) {
		// TODO Auto-generated method stub
		WebElement rows = dr
				.findElement(By.xpath(p1.getProperty("dboard_name_1") + i + p1.getProperty("dboard_name_2")));

		while (dr.findElement(By.xpath(p1.getProperty("dboard_name_1") + i + p1.getProperty("dboard_name_2")))
				.isDisplayed()) {
			js.executeScript("arguments[0].scrollIntoView()",
					dr.findElement(By.xpath(p1.getProperty("dboard_name_1") + i + p1.getProperty("dboard_name_2"))));
			name = dr.findElement(By.xpath(p1.getProperty("dboard_name_1") + i + p1.getProperty("dboard_name_2")))
					.getText();
	...
	/*
	 * public static void scroll_page(String dboard_name_1, String dboard_name_2,
	 * int i, WebDriver dr, JavascriptExecutor js1, String nme) { // TODO
	 * Auto-generated method stub String name;
	 * 
	 * WebElement rows = dr.findElement(By.xpath(dboard_name_1 + i +
	 * dboard_name_2));
	 * 
	 * while (dr.findElement(By.xpath(dboard_name_1 + i +
	 * dboard_name_2)).isDisplayed()) {
	 * js1.executeScript("arguments[0].scrollIntoView()",
	 * dr.findElement(By.xpath(dboard_name_1 + i + dboard_name_2))); name =
	 * dr.findElement(By.xpath(dboard_name_1 + i + dboard_name_2)).getText();
	 * 
	 * if (name.equals(nme)) { System.out.println(name);
	 * js1.executeScript("arguments[0].click();", rows);
	 * System.out.println("Dashboard is Created"); break; } i++; } }
	 */
